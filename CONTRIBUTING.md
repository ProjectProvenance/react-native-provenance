...
There's an `.env.sample` copy it to `.env` and re-start expo.
You can specify API host, and Bundles. See the env file for reference. Note that if you are adding a new variable `EXPO_PUBLIC_` prefix is mandatory.
